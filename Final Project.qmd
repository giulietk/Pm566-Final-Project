...
for (vitamin in vitamin_vars) {
  ...
  scatter_plot <- ggplot(plot_data, aes(x = Nutrient, y = Vitamin)) +
    geom_point_interactive(aes(color = Nutrient_Name, tooltip = paste("Nutrient:", Nutrient, "<br>Vitamin:", Vitamin))) +
  ...
  # Convert ggplot to girafe interactive plot
  interactive_plots[[vitamin]] <- girafe(ggobj = scatter_plot)
}

# Now interactive_plots contains three separate plots for B1, B2, and B6.
# To view each plot, simply call:
